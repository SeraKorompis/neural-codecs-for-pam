#!/bin/bash
#PBS -N eval_ne_ovr_all
#PBS -l walltime=24:00:00
#PBS -l select=1:ncpus=4:mem=32gb
#PBS -o logs/eval_northeastern_ovr_all.out
#PBS -e logs/eval_northeastern_ovr_all.err
...
EVAL="python scripts/downstream/transfer_learned/evaluate_classifier.py --dataset northeastern_ovr"
